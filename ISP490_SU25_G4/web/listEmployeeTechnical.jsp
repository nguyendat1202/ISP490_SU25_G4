<%-- 
    Document   : listEmployeeTechnical
    Created on : Jun 12, 2025, 11:02:31 AM
    Author     : NGUYEN MINH
--%>

<%@page contentType="text/html" pageEncoding="UTF-8"%>
<%@ taglib uri="http://java.sun.com/jsp/jstl/core" prefix="c" %>
<c:set var="currentPage" value="listEmployeeTechnical" />
<c:set var="isEmployeeSectionActive" value="${currentPage == 'listEmployeeCustomer' || currentPage == 'listEmployeeTechnical' || currentPage == 'listEmployeeAdmin'}" />
...
<html lang="vi">
    <head>
        ...
        <title>Nhân viên Kỹ thuật</title>
        ...
        <div class="app-container">
            ...
            <main class="main-content">
                <header class="main-top-bar">
                    <div class="page-title">Nhân viên Kỹ thuật</div>
